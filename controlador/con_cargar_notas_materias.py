...
@app.route('/cargar_notas_secciones/<int:cod_grado>/cargar_notas_materias')
def cargar_notas_materias(cod_grado):
	if g.user:
		...
		return render_template("vis_cargar_notas_materias.html", materias = materias)
